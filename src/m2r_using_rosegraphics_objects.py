...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher, Mark Hays,
         Aaron Wilkin, their colleagues, and Mike Stevens.
...
#            window = rg.RoseWindow(300, 100, 'Window 1')
#
...
#        necessary?  Why?
#            When you want to close the window or open a new window since only one can run at a time
#
